  ...
  return (
    <figure className="relative bg-gray-100 rounded-lg border border-gray-200 overflow-hidden my-6">
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div className="relative h-64 md:h-full col-span-1 rounded-xl overflow-hidden">
          <Image
            src={imageUrl}
            alt={block.photo.alternativeText || block.authorName}
            layout="fill"
            objectFit="contain" // ทำให้รูปภาพไม่ตัดและย่อ
            className="w-full h-full object-center rounded-xl" // เพิ่มมุมโค้งมนที่รูปภาพ
          />
        </div>
        <div className="p-8 col-span-2 flex flex-col justify-center">
          <blockquote className="relative">
            ...
            <p className="relative text-xl font-medium text-gray-600 mb-4">
              {block.quote}
            </p>
          </blockquote>
          <figcaption className="font-semibold text-blue-600 mt-2">
            {block.authorName}
          </figcaption>
        </div>
      </div>
